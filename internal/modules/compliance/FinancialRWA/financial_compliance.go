...
type FinancialcomplianceBuyerApproved struct {
	...
	CreditInsuranceApproved bool
	SerasaClearance         bool
	DocumentsVerified       bool
	Income                  *big.Int
	AddressVerified         common.Hash
	SaleRegistered          bool
	SignedAgreement         bool
	Raw                     types.Log // Blockchain specific contextual infos
}

// FilterBuyerApproved is a free log retrieval operation binding the contract event 0x5d619b2d34bb4b42202a1b22720ed0ce4c21d01d1b6bd98234ad6d138df7c0c6.
//
// Solidity: event BuyerApproved(address indexed buyer, bool creditInsuranceApproved, bool serasaClearance, bool documentsVerified, uint256 income, string indexed addressVerified, bool saleRegistered, bool indexed signedAgreement)
func (_Financialcompliance *FinancialcomplianceFilterer) FilterBuyerApproved(opts *bind.FilterOpts, buyer []common.Address, addressVerified []string, signedAgreement []bool) (*FinancialcomplianceBuyerApprovedIterator, error) {
	...
	var addressVerifiedRule []interface{}
	for _, addressVerifiedItem := range addressVerified {
		addressVerifiedRule = append(addressVerifiedRule, addressVerifiedItem)
	}

	var signedAgreementRule []interface{}
	for _, signedAgreementItem := range signedAgreement {
		signedAgreementRule = append(signedAgreementRule, signedAgreementItem)
	}

	logs, sub, err := _Financialcompliance.contract.FilterLogs(opts, "BuyerApproved", buyerRule, addressVerifiedRule, signedAgreementRule)
	if err != nil {
		return nil, err
	}
...
// WatchBuyerApproved is a free log subscription operation binding the contract event 0x5d619b2d34bb4b42202a1b22720ed0ce4c21d01d1b6bd98234ad6d138df7c0c6.
//
// Solidity: event BuyerApproved(address indexed buyer, bool creditInsuranceApproved, bool serasaClearance, bool documentsVerified, uint256 income, string indexed addressVerified, bool saleRegistered, bool indexed signedAgreement)
func (_Financialcompliance *FinancialcomplianceFilterer) WatchBuyerApproved(opts *bind.WatchOpts, sink chan<- *FinancialcomplianceBuyerApproved, buyer []common.Address, addressVerified []string, signedAgreement []bool) (event.Subscription, error) {
	...
	logs, sub, err := _Financialcompliance.contract.WatchLogs(opts, "BuyerApproved", buyerRule, addressVerifiedRule, signedAgreementRule)
	if err != nil {
		return nil, err
	}
...
// ParseBuyerApproved is a log parse operation binding the contract event 0x5d619b2d34bb4b42202a1b22720ed0ce4c21d01d1b6bd98234ad6d138df7c0c6.
//
// Solidity: event BuyerApproved(address indexed buyer, bool creditInsuranceApproved, bool serasaClearance, bool documentsVerified, uint256 income, string indexed addressVerified, bool saleRegistered, bool indexed signedAgreement)
